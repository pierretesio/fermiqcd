...
#include "InitGrace.h"                        // The other includes are just for plotting or fitting
#include "Functions.h"
...
/// /////////////////////
  ...
  if(systemchoice==0&&nc!=2){cout<<"fast version implemented only for Nc=2!!!"<<endl;abort();}
/// /////////////////////
/// ITERATION CONTROL //
/// ///////////////////
  int decorel=2,nheat=100;                    /// decorrelation and heating
...
//
        if(zloop==zmax-1)     // Fit and plot potential when all z are calculated
            {
            #include "FitPlot_Pot.h"      //fit the potential and plot it
            #include "Plot_a.h"           //plot the deduced value of a
            }
	}                     //end of z loop
